...
//        $('#personas').append("<p> <a href=" + element._links.mainEntityOfPage + " target=”_blank”> " + element.name + "</a></p>");
        $('#personas').append("<p> <a href=" + element._links.mainEntityOfPage + " target=”_blank”> " + element.name + "</a>" + direccion + "</p>");
//        $('#personas').append("<button onclick=" + persona(element._links.mainEntityOfPage,element.name) +"> " + element.name + "</button>");
    });
}
